...
This guide introduced relations in the context od a PostgreSQL database as well as SQL, which enables us to query the data stored within it. An understanding of this content provides us with the mental models needed to build sophisticated web applications.
